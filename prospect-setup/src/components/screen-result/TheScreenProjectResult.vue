<template>
	<div class="the-screen-project-result">
		<div class="project-eligible" v-if="isProjectEligible">
			...
			<a :href="criteriaLink" target="_blank">{{ $t('project-setup.project-result.SUBTITLES_SELECTION_STANDARDS_LINK') }}</a>.</div>
...
export default {
	...
	computed: {
		...
		criteriaLink () {
			return i18n.t('project-setup.project-result.SUBTITLES_SELECTION_STANDARDS_LINK_URL')
		}
	},
	methods: {
		getTotalAmount () {
